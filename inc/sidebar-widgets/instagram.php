...
----------------------------------------*/
class hus_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('hus_instagram_photo',esc_html__('[ Hus ] Intagram Photo','hus-companion'),array(
			'description' => esc_html__('Hus Instagram Photo Widget','hus-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'hus-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'hus-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'hus-companion'); ?></label>
...
if(!function_exists('hus_instagram_widgets')):
	function hus_instagram_widgets(){
		register_widget('hus_instagram_photo');
	}
	add_action('widgets_init','hus_instagram_widgets');
endif;
