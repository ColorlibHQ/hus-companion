...
class Hus_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Hus ] Social Links', 'hus-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'hus-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'hus-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'hus-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'hus-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'hus-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'hus-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'hus-companion'); ?></label>
...
} // Class hus_social_links ends here


// Register and load the widget
function hus_social_links_widget_load() {
	register_widget( 'Hus_social_links' );
}
add_action( 'widgets_init', 'hus_social_links_widget_load' );