...
/**
 *
 * Hus elementor quotation section widget.
 *
 * @since 1.0
 */
class Hus_Quotation_Section extends Widget_Base {

	public function get_name() {
		return 'hus-quotation';
	}

	public function get_title() {
		return __( 'Quotation Section', 'hus-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => __( 'Have any questions in mind?', 'hus-companion' ),
            ]
        );
        $this->add_control(
            'btn_label',
            [
                'label' => esc_html__( 'Button Label', 'hus-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => __( 'Contact Us', 'hus-companion' ),
            ]
        );
        $this->add_control(
            'btn_url',
            [
                'label' => esc_html__( 'Button URL', 'hus-companion' ),
        ...
        $this->add_control(
            'sec_img',
            [
                'label' => esc_html__( 'Right Image', 'hus-companion' ),
                'description' => esc_html__( 'Best size is 922x656', 'hus-companion' ),
        ...
        $this->add_control(
            'phone_label',
            [
                'label' => esc_html__( 'Phone Label', 'hus-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'say Hello,', 'hus-companion' ),
            ]
        );
        $this->add_control(
            'phone_number',
            [
                'label' => esc_html__( 'Phone Number', 'hus-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( '+44 563 986 4785', 'hus-companion' ),
            ]
        );
        $this->end_controls_section(); // End left content
        ...
        $this->start_controls_section(
            'quotation_styles', [
                'label' => __( 'Quotation Section Styles', 'hus-companion' ),
        ...
        $this->add_control(
            'highlighted_col', [
                'label' => __( 'Highlighted Text Color', 'hus-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
