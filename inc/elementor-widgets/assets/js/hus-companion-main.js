(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".hus-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".hus-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.hus-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.hus-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.hus-subscribe-newsletter-area');
    if ($subscribe.length) {
