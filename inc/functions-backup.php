...
// Section Heading
function hus_section_heading( $title = '', $subtitle = '' ) {
	if( $title || $subtitle ) :
	?>
		<div class="container">
			<div class="row">
...
// Enqueue scripts
add_action( 'wp_enqueue_scripts', 'hus_companion_frontend_scripts', 99 );
function hus_companion_frontend_scripts() {

	wp_enqueue_script( 'hus-companion-script', plugins_url( '../js/loadmore-ajax.js', __FILE__ ), array( 'jquery' ), '1.0', true );
	wp_enqueue_script( 'hus-common-js', plugins_url( '../js/common.js', __FILE__ ), array( 'jquery' ), '1.0', true );

}
// 
add_action( 'wp_ajax_hus_portfolio_ajax', 'hus_portfolio_ajax' );

add_action( 'wp_ajax_nopriv_hus_portfolio_ajax', 'hus_portfolio_ajax' );
function hus_portfolio_ajax( ){
	...
	function hus_update_the_followed_post_page_status( $title = 'Hello world!', $type = 'post', $status = 'draft', $message = false ){
...
function listing_custom_posts() {	
	$labels = array(
		'name'               => _x( 'Listing', 'post type general name', 'hus-companion' ),
		'singular_name'      => _x( 'Listing', 'post type singular name', 'hus-companion' ),
		'menu_name'          => _x( 'Listing', 'admin menu', 'hus-companion' ),
		'name_admin_bar'     => _x( 'Listing', 'add new on admin bar', 'hus-companion' ),
		'add_new'            => _x( 'Add New', 'hus', 'hus-companion' ),
		'add_new_item'       => __( 'Add New Listing', 'hus-companion' ),
		'new_item'           => __( 'New Listing', 'hus-companion' ),
		'edit_item'          => __( 'Edit Listing', 'hus-companion' ),
		'view_item'          => __( 'View Listing', 'hus-companion' ),
		'all_items'          => __( 'All Listings', 'hus-companion' ),
		'search_items'       => __( 'Search Listing', 'hus-companion' ),
		'parent_item_colon'  => __( 'Parent Listing:', 'hus-companion' ),
		'not_found'          => __( 'No Listing found.', 'hus-companion' ),
		'not_found_in_trash' => __( 'No Listing found in Trash.', 'hus-companion' )
	);

	$args = array(
		'labels'             => $labels,
		'description'        => __( 'Description.', 'hus-companion' ),
		'public'             => true,
	...
	$labels = array(
		'name'              => _x( 'Listing Category', 'taxonomy general name', 'hus-companion' ),
		'singular_name'     => _x( 'Listing Categories', 'taxonomy singular name', 'hus-companion' ),
		'search_items'      => __( 'Search Listing Categories', 'hus-companion' ),
		'all_items'         => __( 'All Listings Categories', 'hus-companion' ),
		'parent_item'       => __( 'Parent Listing Category', 'hus-companion' ),
		'parent_item_colon' => __( 'Parent Listing Category:', 'hus-companion' ),
		'edit_item'         => __( 'Edit Listing Category', 'hus-companion' ),
		'update_item'       => __( 'Update Listing Category', 'hus-companion' ),
		'add_new_item'      => __( 'Add New Listing Category', 'hus-companion' ),
		'new_item_name'     => __( 'New Listing Category Name', 'hus-companion' ),
		'menu_name'         => __( 'Listing Category', 'hus-companion' ),
	);
	...
	$labels = array(
		'name'              => _x( 'Listing Country', 'taxonomy general name', 'hus-companion' ),
		'singular_name'     => _x( 'Listing Countries', 'taxonomy singular name', 'hus-companion' ),
		'search_items'      => __( 'Search Listing Countries', 'hus-companion' ),
		'all_items'         => __( 'All Listings Countries', 'hus-companion' ),
		'parent_item'       => __( 'Parent Listing Country', 'hus-companion' ),
		'parent_item_colon' => __( 'Parent Listing Country:', 'hus-companion' ),
		'edit_item'         => __( 'Edit Listing Country', 'hus-companion' ),
		'update_item'       => __( 'Update Listing Country', 'hus-companion' ),
		'add_new_item'      => __( 'Add New Listing Country', 'hus-companion' ),
		'new_item_name'     => __( 'New Listing Country Name', 'hus-companion' ),
		'menu_name'         => __( 'Listing Country', 'hus-companion' ),
	);
...
/*=========================================================
    Cases Section
========================================================*/
function hus_case_section( $post_order ){ 
	...
	if( $cases->have_posts() ) {
		while ( $cases->have_posts() ) {
			...
			$case_img      = get_the_post_thumbnail( get_the_ID(), 'hus_case_study_thumb_362x240', '', array( 'alt' => get_the_title() ) );
			?>
...
// Related hus for Single Page
function hus_related_items( $current_post_id = null, $post_item = 3, $post_order = 'DESC', $have_related_listing_title = 'Related Listings' ){
			...
			<div class="row">
				...
				if( $related_listings->have_posts() ) {
					while ( $related_listings->have_posts() ) {
						...
						$recipe_img = get_the_post_thumbnail( get_the_ID(), 'hus_listing_thumb_362x250', '', array( 'alt' => get_the_title() ) );
						$listing_address = ! empty( hus_meta( 'listing_address') ) ? hus_meta( 'listing_address') : 'N/A';
						$phone_number = ! empty( hus_meta( 'phone_number') ) ? hus_meta( 'phone_number') : 'N/A';
						$listing_email = ! empty( hus_meta( 'listing_email') ) ? hus_meta( 'listing_email') : 'N/A';
						?>
...
function hus_get_tabbed_contents( $sec_title = 'Explore Europe', $selected_countries ) {
	$i = 0;
	?>
						...
						<div class="row">
							...
							if( $tabbed_listings->have_posts() ) {
								while ( $tabbed_listings->have_posts() ) {
									...
									$listing_img = get_the_post_thumbnail( get_the_ID(), 'hus_listing_thumb_362x250', '', array( 'alt' => get_the_title() ) );
									$listing_address = ! empty( hus_meta( 'listing_address') ) ? hus_meta( 'listing_address') : 'N/A';
									$phone_number = ! empty( hus_meta( 'phone_number') ) ? hus_meta( 'phone_number') : 'N/A';
									$listing_email = ! empty( hus_meta( 'listing_email') ) ? hus_meta( 'listing_email') : 'N/A';
									?>
	...
	function search_prop_form_datas() {
		...
		$properties = new WP_Query( array(
			...
			'meta_query' => array(
				'relation' => 'OR',
				array(
					'key'     => '_hus_listing_price',
					'value'   => array(1000, 1000000),
					'type'    => 'numeric',
					'compare' => 'BETWEEN',
				),
				array(
					'key'     => '_hus_listing_area',
					'value'   => array(1000, 1000000),
					'type'    => 'numeric',
					'compare' => 'BETWEEN',
				),
		...
		if( $properties->have_posts() ) {
			while ( $properties->have_posts() ) {
				$properties->the_post();		
				$property_img = get_the_post_thumbnail( get_the_ID(), 'hus_listing_thumb_362x250', '', array( 'alt' => get_the_title() ) );
